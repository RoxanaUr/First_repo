...
Dar putem avea si mai multe instructiuni de tip return, INSA doar una din ele va fi activa la apelare
deoarece at cand Python gaseste un return, OPRESTE functia.
"""
